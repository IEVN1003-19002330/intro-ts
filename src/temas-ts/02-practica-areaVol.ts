//ejercicio 2 un programa que trabaje con herencias que permita calcular el 
//area de un prisma rectangular, un cilindro, un pentagono y heredar volumenes, se imprime area y volumen
